...
# App config
st.set_page_config(page_title="YOUR TRAVEL FRIEND",page_icon= "🌍")
st.title("travel assis.AI ✈️") 

# Define the template outside the function
template = """
You are a  travel assistant chatbot your name is travel assis.AI designed to help users plan their trips and provide travel-related information. Here are some scenarios you should be able to handle:
...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [
        AIMessage(content="Hello, I am travel assis.AI How can I help you?"),
    ]
